...
NOTE: Con l'aggiornamento degli strumenti ONTAP 9.12, tutti i processi di autenticazione e comunicazione dei sistemi di archiviazione vengono modificati dall'autenticazione di base all'autenticazione basata su certificato, tramite l'auto-fiducia nei certificati di archiviazione ONTAP .
