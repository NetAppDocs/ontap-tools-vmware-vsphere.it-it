...
Per ulteriori informazioni, consultare https://library.netapp.com/ecm/ecm_download_file/ECMLP2886292["Note sulla versione dei tool ONTAP per VMware vSphere 9,13"^].
